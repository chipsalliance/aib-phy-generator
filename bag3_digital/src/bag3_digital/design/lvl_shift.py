...
class LvlShiftDesigner(DesignerBase):

    async def async_design(self, cload: float, dmax: float, trf_in: float, tile_specs: Mapping[str, Any],
    ...
    async def _design_lvl_shift_internal_inv(self, pseg: int, nseg: int, out_inv_m: int, fanout: float,
    ...
    async def _design_lvl_shift_inv_pun(self, pseg: int, nseg: int, inv_nseg: int, out_inv_m: int, fanout: float,
    ...
    async def _design_output_inverter(self, inv_in_pseg: int, inv_in_nseg: int, pseg: int, nseg: int, inv_nseg: int,
